...
Entry.getRange = function(receiver, perceiver, contexts, fn){
     ...
     // Start building the context query 开始构建上下文查询

     var context_query1 = '';
     var context_query2 = '';

     // Are the contexts passed? If yes, add contextual query 上下文通过了吗?如果是的,添加上下文查询
     ...
     // Now who sees what? 此时可见信息判断

    // Perceiver - the one who made the graph 图创建者
    // Receiver - the one who's watching it 图接收者
     ...
     // We retrieve statements to somebody who did not make them 我们的人并没有使他们检索语句
         ...
         // 人的观看的东西不是让他们的人,所以我们包括节点属于私人上下文
